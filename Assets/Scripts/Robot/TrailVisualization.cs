...
public class TrailVisualization : MonoBehaviour
{
    ...
    void Awake()
    {
        _childTransforms = _robot.GetComponentsInChildren<Transform>();

        //MeshRenderer[] meshRenderers = _robot.GetComponentsInChildren<MeshRenderer>();
        ...
        BuildTemplate(_robot.transform, _template);
    ...
    {
        GameObject go = Instantiate(_template, transform);
