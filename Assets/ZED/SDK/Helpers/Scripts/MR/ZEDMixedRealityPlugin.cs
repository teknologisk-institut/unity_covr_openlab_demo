...
public class ZEDMixedRealityPlugin : MonoBehaviour
{
	...
	void ZEDReady()
	{
		...
		if (zedCamera.ImageWidth != 1280 && zedCamera.ImageHeight != 720)
            UnityEngine.Debug.LogWarning ("[ZED AR Passthrough] This resolution is not ideal for a proper AR passthrough experience. Recommended resolution is 1280x720.");
