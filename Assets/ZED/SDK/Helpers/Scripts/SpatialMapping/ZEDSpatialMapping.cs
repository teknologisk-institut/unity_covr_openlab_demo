...
public class ZEDSpatialMapping
{
    ...
    public bool LoadMesh(string meshFilePath = "ZEDMesh.obj")
    {
        ...
        {
            UnityEngine.Debug.LogWarning(ZEDLogMessage.Error2Str(ZEDLogMessage.ERROR.TRACKING_BASE_AREA_NOT_FOUND));
        }
        ...
        {
            UnityEngine.Debug.LogWarning(ZEDLogMessage.Error2Str(ZEDLogMessage.ERROR.TRACKING_NOT_INITIALIZED));
        }
    ...
    private void SaveMeshNow(string meshFilePath = "Assets/ZEDMesh.obj")
    {
        ...
        {
            UnityEngine.Debug.LogError("Couldn't save to " + meshFilePath + ": Must save as .obj.");
        }

        lock (lockScanning)
        {
            UnityEngine.Debug.Log("Saving mesh to " + meshFilePath);
    ...
    private class ZEDSpatialMappingHelper
    {
        ...
        public bool LoadMesh(string meshFilePath)
        {
            ...
            if (!r) UnityEngine.Debug.LogWarning("[ZED] Failed to load mesh: "+ meshFilePath);
            vertices = new Vector3[numVertices];
            uvs = new Vector2[numVertices];
            triangles = new int[3 * numTriangles];
            return r;
