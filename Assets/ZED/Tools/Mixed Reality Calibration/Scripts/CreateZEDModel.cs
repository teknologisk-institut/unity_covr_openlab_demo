...
public class CreateZEDModel : MonoBehaviour
{
    ...
    private void CreateModel()
    {
        ...
        if (model == sl.MODEL.ZED)
        {
            if (!zedModelPrefab)
            {
                UnityEngine.Debug.LogError("CameraAnchor tried to spawn ZED Model but zedModelPrefab is null.");
                return;
            }
        ...
        else if (model == sl.MODEL.ZED_M)
        {
            ...
            {
                UnityEngine.Debug.LogError("CameraAnchor tried to spawn ZED Mini Model but zedMiniModelPrefab is null.");
                return;
            }
