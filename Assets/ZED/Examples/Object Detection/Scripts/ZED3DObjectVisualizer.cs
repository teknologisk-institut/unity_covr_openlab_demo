...
public class ZED3DObjectVisualizer : MonoBehaviour
{
    ...
    private void ReturnBoxToPool(int id, GameObject bbox)
    {
        ...
        {
            UnityEngine.Debug.LogError("Tried to remove object ID " + id + " from active bboxes, but it wasn't in the dictionary.");
        }
    }
    ...
    private void DrawDebugBox(DetectedObject dobj)
    {
        ...
        UnityEngine.Debug.DrawLine(corners3d[0], corners3d[1], Color.red);
        UnityEngine.Debug.DrawLine(corners3d[1], corners3d[2], Color.red);
        UnityEngine.Debug.DrawLine(corners3d[2], corners3d[3], Color.red);
        UnityEngine.Debug.DrawLine(corners3d[3], corners3d[0], Color.red);

        UnityEngine.Debug.DrawLine(corners3d[4], corners3d[5], Color.red);
        UnityEngine.Debug.DrawLine(corners3d[5], corners3d[6], Color.red);
        UnityEngine.Debug.DrawLine(corners3d[6], corners3d[7], Color.red);
        UnityEngine.Debug.DrawLine(corners3d[7], corners3d[4], Color.red);

        UnityEngine.Debug.DrawLine(corners3d[0], corners3d[4], Color.red);
        UnityEngine.Debug.DrawLine(corners3d[1], corners3d[5], Color.red);
        UnityEngine.Debug.DrawLine(corners3d[2], corners3d[6], Color.red);
        UnityEngine.Debug.DrawLine(corners3d[3], corners3d[7], Color.red);
    }
}
